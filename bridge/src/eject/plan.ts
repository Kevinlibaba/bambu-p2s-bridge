 ...
 *
 * 前脸大部分是竖直平面（机器配置里的标量看不出这一点，是照着实机侧影
 * 确认的）。件靠着竖直墙是翻不过去的 —— 一旦开始倾斜，更高处立刻重新
 * 接触把它顶回来；单点推头没有这个性质。喷嘴则明显缩在前脸之后、
 * 挂在主体底面之下。前脸靠下还有一个倒角，见 frontFirst 上的说明。
 *
 ...
 *
 * 打印头的侧影不对称：前脸大部分是竖直平面，但**前脸靠下有一个倒角**，
 * 而倒角正好在推的前进方向上。11.2mm 的件是在 5-11mm 这一段被推走的，
 * 说明起作用的是倒角以上的竖直部分。倒角到底伸到多高没量过，
 * 也就不知道多矮的件会被斜面顶得爬上去而不是被推走 —— 想支持矮件之前
 * 得先把这个量出来。
 */
