 ...
 *
 * 前脸是一整面贯通全高的竖直平面（机器配置里的标量看不出这一点，是照着
 * 实机侧影确认的）。件靠着竖直墙是翻不过去的 —— 一旦开始倾斜，更高处
 * 立刻重新接触把它顶回来；单点推头没有这个性质。喷嘴则明显缩在前脸之后、
 * 挂在主体底面之下。
 *
 ...
 *
 * 方向不可反。打印头的侧影是不对称的：前脸是一整面竖直平面，
 * 后下角却是个倒角。朝 +Y 推的话，件迎上的是斜面，会被顶得爬上去
 * 而不是被推走。所以 -Y 是唯一能拿平面去推的方向 —— 这是几何决定的，
 * 不是偏好，改成可配置之前先想清楚这一点。
 */
